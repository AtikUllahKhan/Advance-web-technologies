...
export default function LoginPage({ userType }: LoginPageProps) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!formData.id.trim()) newError.id = "Please enter your ID.";
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-cover bg-center">
      <div className="relative w-full max-w-lg p-8 bg-[#fcc3c3] rounded-xl shadow-lg">
        ...
        <CardContent>
          <h1 className="text-3xl font-semibold text-center mb-6 text-gray-800 capitalize">{userType} Admin Login</h1>
