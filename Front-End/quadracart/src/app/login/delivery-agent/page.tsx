...
export default function LoginPage({ userType }: LoginPageProps) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await axios.post(`http://localhost:3000/delivery-agent/login`, formData);
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-cover bg-center">
      <div className="relative w-full max-w-lg p-8 bg-[#b9f5cf] rounded-xl shadow-lg">
        ...
        <CardContent>
          <h1 className="text-3xl font-semibold text-center mb-6 text-gray-800 capitalize">{userType} Delivery Agent Login</h1>
          ...
          <div className="text-center mt-6 text-sm">
            <p>
              ...
              <span
                ...
                onClick={() => router.push(`/register/delivery-agent`)}
              >
                Register here
              </span>
            </p>
